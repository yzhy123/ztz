...
<c:forEach items="${list}" var="permissionList">
	<li class="layui-nav-item">
		<a href="javascript:;" data-url="system.html" data-id='6' data-text="${permissionList.permissionName}"><i class="iconfont">&#xe60b;</i>${permissionList.permissionName}</a>
	</li>
</c:forEach>
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  ...
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="admin-info.html" data-id='5' data-text="个人信息">${roleName}</a>
					  </li>
					...
					<div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
					    	<!--1-->
					    	<iframe src="<%=request.getContextPath()%>/admin/index/welcome.html" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0"></iframe>
					    	<!--1end-->
					    </div>
					  </div>
					</div>
