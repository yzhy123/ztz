...
(function(){
    var footerhtml =  '<!-- 公共底部  --><!-- footer\\ -->'
                    + ''
                    + '<!-- copyright\\ -->'
                    + '<div class="lv-footer clearfix wrap" style="margin:0 auto 10px;">'
                    + '    <p class="footer-link">'
                    + '       <a href="http://www.lvmama.com/public/about_lvmama" rel="nofollow">关于1我们</a> | '
                    ...
                    + '       <a rel="nofollow" href="http://www.lvmama.com/info/public/ued/">用户体验平台</a>'
                    + '    </p>'
                    + '    <p class="lv-copyright">Copyright &copy; 2014 www.lvmama.com. 上海景域文化传播有限公司版权所有&#12288;<a href="http://www.miitbeian.gov.cn" target="_blank" rel="nofollow">沪ICP备13011172号-3</a>&#12288;增值电信业务经营许可证编号：<a rel="nofollow" href="http://pic.lvmama.com/img/ICP.jpg" target="_blank">沪B2-20100030</a></p>'
                    + ''
                    + '   <div class="lv-safety">'
